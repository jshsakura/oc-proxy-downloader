...
_RULES: Tuple[Tuple[str, str, str, str, bool], ...] = (
    ...
    ("페이지 로드 실패: http 404",
     "호스터 페이지가 404 를 반환했습니다 (링크 만료 / 일시 세션 손실 / 파일 삭제 가능성)",
     "다시 시도해주세요. 반복되면 '전체 링크 검수' 로 진짜 죽었는지 확인하세요.",
     KIND_TRANSIENT, False),
    ("페이지 로드 실패: http 410",
     "호스터 페이지가 410 (Gone) 을 반환했습니다 (링크 만료 / 일시 세션 손실 가능성)",
     "다시 시도해주세요. 반복되면 '전체 링크 검수' 로 확인하세요.",
     KIND_TRANSIENT, False),
    ("페이지 로드 실패: http 503",
     "호스터 서버가 일시적으로 점검 중입니다 (페이지 로드 503)",
     "잠시 후 다시 시도하세요.",
     KIND_TRANSIENT, False),
    ("페이지 로드 실패", "호스터 페이지를 가져오지 못했습니다",
    ...
    ("http 502", "호스터 서버가 일시적으로 응답하지 않습니다",
     "잠시 후 다시 시도하세요.",
     KIND_TRANSIENT, False),
    ("http 503", "호스터 서버가 일시적으로 점검 중입니다",
     "잠시 후 다시 시도하세요.",
     KIND_TRANSIENT, False),
    ...
    ("connection reset", "연결이 강제로 끊겼습니다",
     ...
     KIND_TRANSIENT, False),
    ("connection refused", "호스터 서버가 연결을 거부했습니다",
