        ...
        <div class="modal-footer">
          <div class="footer-left">
            <div class="footer-links">
              <a href="https://github.com/jshsakura/oc-proxy-downloader" target="_blank" rel="noopener noreferrer" class="footer-link github-link" title="GitHub Repository">
              ...
              <a href="https://hub.docker.com/r/jshsakura/oc-proxy-downloader" target="_blank" rel="noopener noreferrer" class="footer-link docker-link" title="Docker Hub">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
